...
|FI Perks|MaD are granted the same perks as FI.|**QA Testers** and above.|
...
|**Admin Use** - Announce|Your announcements should be professional, and only when required (e.g. to announce server shutdowns or hotfixing issues)|**Senior Developer/Line Rank** and above|None
...
|**Admin Use** - Viewing / Tracking|You may only use view or track in order to detect exploiters - you cannot use it on anyone who is not a Class D, or MaD|**Senior Developer/Line Rank** and above|None|
